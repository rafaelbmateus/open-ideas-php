...
CREATE TABLE tb_incubator (
  incubator_id INTEGER UNSIGNED  NOT NULL   AUTO_INCREMENT,
  incubator_name VARCHAR(255)  NOT NULL  ,
  incubator_description VARCHAR(1200)  NULL  ,
  incubator_url VARCHAR(255)  NULL  ,
  incubator_phone VARCHAR(255)  NULL  ,
  incubator_state VARCHAR(2)  NULL  ,
  incubator_city VARCHAR(255)  NULL  ,
  created_at TIMESTAMP  NOT NULL  ,
  updated_at TIMESTAMP  NULL  ,
  is_deleted BOOL  NULL    ,
...
CREATE TABLE tb_user (
  ...
  user_document INTEGER UNSIGNED  NULL  ,
  user_resume VARCHAR(500)  NULL  ,
  is_deleted BOOL  NULL  ,
  created_at TIMESTAMP  NOT NULL  ,
  updated_at TIMESTAMP  NULL    ,
PRIMARY KEY(user_id)  ,
INDEX tb_user_FKIndex1(type_id)  ,
INDEX tb_user_FKIndex2(job_id),
  FOREIGN KEY(type_id)
...
CREATE TABLE tb_challenge (
  ...
  challenge_description VARCHAR(1200)  NULL  ,
  challenge_deadline DATE  NULL  ,
  created_at VARCHAR(255)  NOT NULL  ,
  updated_at TIMESTAMP  NULL  ,
  is_deleted BOOL  NULL  ,
  challenge_attachment VARCHAR(255)  NULL    ,
PRIMARY KEY(challenge_id)  ,
INDEX tb_challenge_FKIndex1(user_id)  ,
INDEX tb_challenge_FKIndex2(area_id),
  FOREIGN KEY(user_id)
...
CREATE TABLE tb_idea (
  ...
  challenge_id INTEGER UNSIGNED  NULL  ,
  user_id INTEGER UNSIGNED  NOT NULL  ,
  idea_is_public BOOL  NULL  ,
  idea_title VARCHAR(80)  NOT NULL  ,
  idea_description VARCHAR(1200)  NOT NULL  ,
  idea_solution VARCHAR(1200) BINARY  NULL  ,
  idea_differential VARCHAR(1200)  NULL  ,
  idea_necessary_skills VARCHAR(500) BINARY  NULL  ,
  idea_target_group VARCHAR(80)  NULL  ,
  created_at TIMESTAMP  NULL  ,
  updated_at TIMESTAMP  NULL  ,
  is_deleted BOOL  NULL  ,
  idea_attachment VARCHAR(255)  NULL    ,
PRIMARY KEY(idea_id)  ,
INDEX tb_idea_FKIndex1(area_id)  ,
...
INDEX tb_comment_FKIndex3(challenge_id),
  FOREIGN KEY(idea_id)
...
INDEX tb_like_FKIndex3(challenge_id),
  FOREIGN KEY(idea_id)
    REFERENCES tb_idea(idea_id)
      ON DELETE NO ACTION
      ON UPDATE NO ACTION,
