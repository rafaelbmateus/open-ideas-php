  ...
  <div class="wrapper">
    ...
    <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold <?php if(isset($menu_users)) echo 'active'; ?>"><a href="<?php echo base_url() . 'users'; ?>" class="waves-effect waves-cyan"><i class="fa fa-user"></i><?php echo $this->lang->line('users');?></a></li>
